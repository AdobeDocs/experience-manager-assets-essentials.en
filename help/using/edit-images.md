...
[!DNL Assets Essentials] provides functionality to create a new template from scratch using [!DNL Adobe Express] embedded editor. To create a new asset using [!DNL Adobe Expresss], execute the below steps:

1. Navigate to **[!UICONTROL My Workspace]** and click **[!UICONTROL Create]**. [!DNL Adobe Express] blank canvas displays within the [!DNL Assets Essentials] user interface.
