...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="https://experienceleague.adobe.com/en/docs/experience-manager-assets-essentials/help/custom-search-filters"><b>Dynamic Media with OpenAPI capabilities</b></a>
        </td>
        <td>
...
<table>
    ...
    <tr>
       <td>Values</td>
        ...
        <li>Click  <span>&#128465;</span> to delete the option value. 
