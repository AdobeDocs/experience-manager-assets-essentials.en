...
&nbsp;&nbsp;&nbsp; *D: Options to sort assets*
&nbsp;&nbsp;&nbsp; *E: Search box*
&nbsp;&nbsp;&nbsp; *F: Upload or drag and drop files using `Add Assets` button*
&nbsp;&nbsp;&nbsp; *G: Create a new foldert*
...
* [My Workspace](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/my-workspace.html?lang=en): My Workspace alows you can add customizable workspace to access widgets of the key areas of Assets that are most relevant to you. It acts like a one-stop solution to get an overview of the work items and gives insights of quick acess to the workflow.
...
* [Collections](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/manage-collections.html?lang=en): Collections are used to share a variety of assets between the users. It includes the mixture of assets, folders, etc.
* [Insights](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/manage-reports.html?lang=en#view-live-statistics): In [!DNL Assets Essentials], you can view real-time insights on your dashboard. Insights allows you to view automatically generated charts and download or upload them for the analysis.
